...
LIMIT ${limit};`,
  ...
  const tableMap = [
    ...
    { table: 'bc_invoice', triggers: ['bc_invoice', 'bc invoice', 'invoice', 'invoices'] },
    { table: 'bc_contact', triggers: ['bc_contact', 'bc contact', 'billing contact', 'contact', 'contacts'] },
    { table: 'bc_paymentinstrument', triggers: ['bc_paymentinstrument', 'bc paymentinstrument', 'payment instrument', 'bank account', 'ach'] },
    { table: 'bc_basemoneyreceived', triggers: ['bc_basemoneyreceived', 'bc money received', 'money received', 'payment', 'payments', 'received payment'] },
